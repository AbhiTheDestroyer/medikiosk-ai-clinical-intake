...
const schemaTs = `export type UserRole = 'PATIENT' | 'DOCTOR' | 'TRIAGE' | 'ADMIN' | 'SYSTEM_ADMIN';
...
fs.writeFileSync(path.join('server', 'db', 'schema.ts'), schemaTs);
console.log('schema.ts written');
